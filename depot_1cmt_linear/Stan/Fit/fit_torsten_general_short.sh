      ...
      do
        for k in "${chain[@]}";
          do
            ...
            mpiexec -n ${i} ./depot_1cmt_prop_torsten_general sample num_warmup=300 num_samples=200 \
            data file=../../Data/stan_data_short.json output file=../Fits/Torsten_General/torsten_general_${i}_jobs_run_${j}_${k}.csv \

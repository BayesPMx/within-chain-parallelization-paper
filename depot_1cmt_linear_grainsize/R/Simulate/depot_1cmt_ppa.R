...
model <- cmdstan_model("depot_1cmt_linear/Stan/Simulate/depot_1cmt_ppa.stan") 
...
data %>%
  select(-IPRED) %>% 
  # write_csv("depot_1cmt_linear_grainsize/Data/depot_1cmt_ppa.csv", na = ".")
  write_csv("depot_1cmt_linear_grainsize/Data/depot_1cmt_prop.csv", na = ".")

params_ind %>%
  # write_csv("depot_1cmt_linear_grainsize/Data/depot_1cmt_ppa_params_ind.csv")
  write_csv("depot_1cmt_linear_grainsize/Data/depot_1cmt_prop_params_ind.csv")

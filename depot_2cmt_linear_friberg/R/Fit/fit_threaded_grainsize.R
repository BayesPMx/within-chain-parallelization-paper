...
sample_and_save_all <- function(threads_per_chain, grainsize){
  ...
  model <- cmdstan_model(
    "depot_2cmt_linear_friberg/Stan/Fit/depot_2cmt_prop_friberg_prop_grainsize.stan",
  ...
  fit <- model$sample(data = stan_data,
                      ...
                      output_basename = str_c("prop_prop_", threads_per_chain, 
                                              "_grainsize_", grainsize),
                      init = init_files)

...
// Torsten's General ODE solver that usees MPI for within-chain parallelization
...
transformed data{ 
  ...
  array[n_subjects, n_cmt] real bioav = rep_array(1.0, n_subjects, n_cmt); // Hardcoding, but could be data or a parameter in another situation
  array[n_subjects, n_cmt] real tlag = rep_array(0.0, n_subjects, n_cmt);  // Hardcoding, but could be data or a parameter in another situation
...
transformed parameters{
...

  {
    ...
    x_ipred = pmx_solve_group_rk45(depot_1cmt_ode,
                                   n_cmt,
                                   n_each_subject,
                                   time,
                                   amt,
